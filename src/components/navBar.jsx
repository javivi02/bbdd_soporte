    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 ">
      <div className="flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to={"/dashboard"} className="flex items-center">
          ...
          <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white">BBDD SOPORTE</span>
        </Link>
            ...
            <li>
              ...
              <div id="dropdownNavbar"
                ...
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  ...
                  <li>
                    <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Equipos</a>
                  </li>
                  <li>
                    <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Departamento</a>
                  </li>
                </ul>
              </div>
            </li>
